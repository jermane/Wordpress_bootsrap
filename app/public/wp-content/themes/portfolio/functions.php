 ...
 */
 ...
 function theme_styles() {
	...
	wp_enqueue_style( 'portfolio-style', get_template_directory_uri() . '/style.css' );
...
function load_fonts(){
	wp_register_style('gfonts', "https://fonts.googleapis.com/css?family=Arimo:400,400i|Lato:700,700i,900");
...
if (!function_exists('theme_scripts')){
	function theme_scripts(){
		// Adds suppport for pages with threaded comments

		if (is_singular() && comments_open() && get_option('thread_comments')){
			wp_enqueue_scripts('comment-repy');
		}
		
		wp_deregister_script('jquery');
		wp_register_script('jquery', 'http://code.jquery.com/jquery-2.1.3.min.js', false, null);
		...
		//Load the costum portfolio_scripts
